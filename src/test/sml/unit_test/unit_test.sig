...
signature UNIT_TEST = sig include UNIT_TEST_BASE
    val assertRaises_Empty : (unit -> 'a) -> unit
    val assertRaises_Subscript : (unit -> 'a) -> unit
    ...
    val assertEqualsAnyOrder_IntListOption : (int list option * int list option) -> unit
    ...
    val assertEqualsAnyOrder_StringListOption : (string list option * string list option) -> unit
end
