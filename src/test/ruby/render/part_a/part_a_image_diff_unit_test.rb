...
class PartAImageDiffUnitTest < Test::Unit::TestCase
  ...
  def test_picture_diff_Rectangle_A
    picture_diff("Rectangle.new(0.4, 0.6)",
                 "Rectangle_A")
  end
  ...
  def test_picture_diff_Ellipse_A
    picture_diff("Ellipse.new(0.1, 0.2)",
                 "Ellipse_A")
  end
  ...
  def test_picture_diff_CircularSegment_A
    picture_diff("CircularSegment.new(0.3, 0.4, -Math::PI/3, Math::PI/2)",
                 "CircularSegment_A")
  end
  ...
  def test_picture_diff_Text_A
    picture_diff("Text.new(\"SML\", Font::TIMES_ROMAN_24)",
                 "Text_A")
  end

  def test_picture_diff_Text_B
    picture_diff("Text.new(\"Racket\", Font::TIMES_ROMAN_24)",
                 "Text_B")
  end

  def test_picture_diff_Text_C
    picture_diff("Text.new(\"Ruby\",Font::TIMES_ROMAN_24)",
                 "Text_C")
  end
  ...
  def test_picture_diff_BezierCurve_A
    picture_diff("p0 = Point2.new(-0.5, -0.5);p1 = Point2.new(-0.25, 0.25);p2 = Point2.new(0.25, -0.5);p3 = Point2.new(0.5, 0.5);BezierCurve.new([p0, p1, p2, p3])",
                 "BezierCurve_A")
  end
