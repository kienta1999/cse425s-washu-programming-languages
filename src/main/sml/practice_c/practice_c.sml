...
(* credit to Pavel Lepin https://ca.linkedin.com/in/pavel-lepin and Charilaos Skiadas http://vault.hanover.edu/~skiadas/ for these practice problems *)
...
fun map_tree (f:'a->'b) (t:'a tree) : 'b tree =
	raise NotYetImplemented

fun fold_tree (f:'a*'b->'b) (acc:'b) (t:'a tree) : 'b =
	raise NotYetImplemented

fun filter_tree (predicate:'a->bool) (t:'a tree) : 'a tree =
	raise NotYetImplemented
